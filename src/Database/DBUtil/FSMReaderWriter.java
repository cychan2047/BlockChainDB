...
public class FSMReaderWriter {
  ...
  private static final int FSM_BLOCK_NUM = 9;

  private static final int FSM_BLOCK_OFFSET = 0;
  private static final int FSM_PFS_FILE_NUM = 0;

  private static final String INITIAL_BITMAP = "0".repeat(256);

  public FSMReaderWriter(int blockSize, int fileSize, String databaseDirectory) {
  ...
  public void initialize(String databaseName) {
    try {
      DBRepository repo = new DBRepository(BLOCK_SIZE, FILE_SIZE, databaseDirectory);
